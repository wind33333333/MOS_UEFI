...
debug-kernel: clean_kernel ${BUILD}/kernel.elf ${BUILD}/kernel.bin
	...
	qemu-system-x86_64 \
	  ...
	  -device usb-storage,drive=bootdisk,bus=xhci.0,port=1,bootindex=1 \
	  `# --- 4. UAS 高速测试盘 (端口 2) ---` \
