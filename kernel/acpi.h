...
//region madt表
typedef struct {
    UINT8    type;                 // 类型，0 表示本地 APIC
    UINT8    length;               // 条目长度，通常为 8
...
typedef struct {
    UINT8   type;                           // 类型，1 表示 IO APIC
    UINT8   length;                         // 条目长度，通常为 12
...
typedef struct {
    UINT8     type;                         // 类型，2 表示中断源重定向
    UINT8     length;                       // 条目长度，通常为 10
...
typedef struct {
    UINT8      type;                        // 类型，4 表示 NMI 源
    UINT8      length;                      // 条目长度，通常为 6
