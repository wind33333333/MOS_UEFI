...
INIT_TEXT void init_buddy_system(void) {
    ...
    //page_table分配内存
    buddy_system.page_table = (page_t*)memblock_vmmap_xx((UINT64)memblock_alloc(buddy_system.page_length,8),_end,buddy_system.page_length>>PAGE_4K_SHIFT,PAGE_ROOT_RW);;
    //初始化page_table为0
