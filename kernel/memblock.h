...
INT32 memblock_vmmap(UINT64 *pml4t, UINT64 pa, void *va, UINT64 attr,UINT64 page_size);
INT32 memblock_vmmap_range(UINT64 *pml4t, UINT64 pa, void *va,UINT64 length, UINT64 attr,UINT64 page_size);
