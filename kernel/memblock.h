...
void memblock_vmmap1(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 page_count, UINT64 attr);
void memblock_vmmap_big(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 length, UINT64 attr);
void memblock_vmmap_huge(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 length, UINT64 attr);
