...
void memblock_vmmap_4k(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 page_count, UINT64 attr);
void memblock_vmmap_2m(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 length, UINT64 attr);
void memblock_vmmap_1g(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 length, UINT64 attr);
