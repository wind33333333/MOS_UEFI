...
void *memblock_vmmap_xx(UINT64 phy_addr, void *virt_addr, UINT64 page_count, UINT64 attr);
void __memblock_vmmap(UINT64 *pml4t, UINT64 phy_addr, void *virt_addr, UINT64 attr);
