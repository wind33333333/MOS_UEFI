...
struct {
    ...
    {AHCI_CLASS_CODE, "SATA Controller (AHCI)"},
    ...
    {UHCI_CLASS_CODE, "USB1.1 Controller (UHCI)"},
    {OHCI_CLASS_CODE, "USB1.1 Controller (OHCI)"},
    {EHCI_CLASS_CODE, "USB2.0 Controller (EHCI)"},
    {XHCI_CLASS_CODE, "USB3.0 Controller (XHCI)"},
