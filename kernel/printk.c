...
INIT_TEXT void init_output(void) {
        ...
        Pos.FB_addr = (UINT32*)memblock_vmmap(boot_info->frame_buffer_base,LADDR_TO_HADDR(boot_info->frame_buffer_base), PAGE_4K_ALIGN(boot_info->frame_buffer_size)>>PAGE_4K_SHIFT,PAGE_ROOT_RW_WC);;
